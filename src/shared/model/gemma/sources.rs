...
pub(crate) fn input_embedding_source(
    ...
    AuthenticatedDecoderEmbeddingSource::from_model(model_id, model)
}
...
pub(crate) fn prefill_ple_source(
    ...
    AuthenticatedDecoderPrefillPleSource::from_model(model_id, model)
}
...
pub(crate) fn prefill_layer_source(
    ...
    AuthenticatedDecoderPrefillLayerSource::from_model(model_id, model)
}
...
pub(crate) fn prefill_finalize_source(
    ...
    AuthenticatedDecoderPrefillFinalizeSource::from_model(model_id, model)
}
...
pub(crate) fn decode_layer_range_source(
    ...
    AuthenticatedDecoderDecodeLayerRangeSource::from_model(identifier, model)
}
...
pub(crate) fn decode_transition_source(
    ...
    AuthenticatedDecoderDecodeTransitionSource::from_model(identifier, model)
}
