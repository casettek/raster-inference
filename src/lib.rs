...
pub use io::{
    ...
    load_embedding_table_from_path, load_tokenizer_from_path,
};
pub use phase1::{
    run_phase1, Gemma4Prompt, InferenceRequest, MessageRole, ModelSpec, Phase1State,
    SamplingConfig, TextDecodingPolicy, TextMessage,
};
pub use phase2::{embed_input_tokens, run_phase2, EmbeddedTokenSequence, EmbeddingTable};

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct InferenceState {
    pub phase1: Phase1State,
    pub phase2: EmbeddedTokenSequence,
}
...
pub fn run_inference(
    ...
    let phase2 = run_phase2(&phase1, embedding_table)?;
