...
use crate::output_finalize::raster_auth_source::{
...
pub fn init_raster_output_detokenize(
    ...
    let (next_roots, _builder) = ArtifactIo::start_builder_with_roots(
        ...
        crate::output_finalize::raster_auth_source::output_text_metadata()?,
    )?;
...
fn append_pending_byte_with_roots(
    ...
    if state.pending_bytes_builder_source_name.is_none() {
        ...
        let (roots, _builder) = ArtifactIo::start_builder_with_roots(
            ...
            crate::output_finalize::raster_auth_source::output_pending_bytes_metadata()?,
        )?;
    ...
    let (roots, _builder_root) = ArtifactIo::append_leaf_by_builder_source_name_with_roots(
        ...
        crate::output_finalize::raster_auth_source::pending_byte_leaf(byte),
    )?;
    state.artifact_store_roots = roots;
...
fn append_text_chunk_with_roots(
    ...
    let (roots, _builder_root) = ArtifactIo::append_leaf_by_builder_source_name_with_roots(
        ...
        crate::output_finalize::raster_auth_source::text_chunk_leaf(chunk),
    )?;
    state.artifact_store_roots = roots;
...
fn read_pending_byte_from_ref_roots(
    ...
    crate::output_finalize::raster_auth_source::decode_pending_byte_leaf(read.payload())
}
...
pub fn detokenize_output_tokens_with_byte_flush_bytes_per_tile(
    ...
    crate::output_finalize::raster_auth_source::materialize_text_from_roots(
...
pub fn run_with_byte_flush_bytes_per_tile(
    ...
    let generated_text = crate::output_finalize::raster_auth_source::materialize_text_from_roots(
        &refs.artifact_store_roots,
        &refs.refs.generated_text_ref,
    )?;
    Ok(call_tile!(
...
mod tests {
    ...
    use crate::output_finalize::raster_auth_source::materialize_text_from_roots;
    use crate::shared::artifacts::artifact_io::ArtifactIo;
    use crate::shared::artifacts::raster_artifact_store::{
