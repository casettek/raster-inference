...
use crate::decode_transition::raster_auth_source::{
...
fn read_decode_layer_scalars(
    source: &AuthenticatedGemmaDecodeTransitionSource,
    layer_idx: usize,
) -> Result<crate::decode_transition::raster_auth_source::GemmaDecodeLayerScalars> {
...
fn read_decode_ple_scalars(
    source: &AuthenticatedGemmaDecodeTransitionSource,
) -> Result<crate::decode_transition::raster_auth_source::GemmaDecodePleScalars> {
...
mod tests {
    ...
    use crate::decode_transition::raster_auth_source::AuthenticatedGemmaDecodeTransitionSource;
