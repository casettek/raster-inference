...
use self::raster_auth_source::AuthenticatedGemmaDecodeTransitionSource;
...
pub fn run_with_mode(
    ...
    let final_hidden_state = match execution_mode {
        InferenceExecutionMode::Fp32 => {
            ...
            native_tiles::run_text_layers_decode_step(
                embedded_token,
                next_token,
                model,
                layer_caches,
...
fn generated_token_ids_commitment(decode_state: &DecodeState) -> Result<String> {
    crate::output_finalize::native_tiles::build_output_decode_commitment(
